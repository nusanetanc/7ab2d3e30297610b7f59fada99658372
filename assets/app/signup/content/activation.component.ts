    ...
    <div class="form-auth-is">
        <div class="container container-auth-client">
            <div class="top-margin text-center" *ngIf="subs.status == 'Registration'">
                <h4 style="color: #FFF; !important;">Enter new password for your Groovy Account</h4>
                <div class="form">
            ...
            <div class="top-margin text-center" *ngIf="subs.status == 'Email Activation'" style="color: #FFF;">
