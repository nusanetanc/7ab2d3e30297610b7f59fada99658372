           ...
           <div class="page-content inset" data-spy="scroll" data-target="#spy">
               ...
               <div class="row subInfo roboto colorInfoDetail">
                   <div class="col-sm-12">
                     ...
                     <div class="row">
                         <div class="col-sm-12 invoiceId grey333"><span>Posted <b>{{stringAsDate(dateinformations.date) | date:'dd MM yy HH:mm:ss'}}</b> by <b>{{ informations.nameusercretae }} ({{ informations.jabusercretae }})</b></span></div>
                     </div>
                     <div class="row">
