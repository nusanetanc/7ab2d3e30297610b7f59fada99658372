            ...
            <div class="row subInfo roboto grey8b reportDetail">
                <div class="col-sm-12">
                    ...
                    <div class="row" *ngFor="#chat of chats">
                        ...
                        <div class="col-sm-11 col-xs-12 postBy marginT10"><span>Posted <b class="grey333">{{ chat.date }}</b> by <b class="grey333">Tes Admin</b><br style="font-weight:700px;">{{ chat.message }}</span></div>
                    </div>
                    <div class="row">
