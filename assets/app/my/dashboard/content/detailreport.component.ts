        ...
        <div class="page-content inset" data-spy="scroll" data-target="#spy">
            ...
            <div class="row subInfo roboto grey8b">
                <div class="col-sm-12">
                  ...
                  <div>
                      <div class="row">
                          <div class="col-sm-12 invoiceId"><span>Posted <b class="grey333">{{ complaints.dateopen }}</b> by <b class="grey333">aaa</b></span></div>
                      </div>
                      <div class="row">
                          <div class="col-sm-11 infoDetail">
                              <span *ngFor="#chat of chatcomplaints">{{ chat.message }}</span>
                          </div>
                      </div>
                    </div>
                </div>
