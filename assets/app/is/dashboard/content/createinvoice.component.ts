                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="row marginTB10 marginL5">
                                ...
                                <div class="col-xs-12 col-md-7">
                                    <input value="{{today | date: 'dd/MM/yyyy'}}" class="form-control inputForm" #invoicedate id="invoicedate" placeholder="Invoice Date" disabled/>
                                </div>
                            </div>
                            <div class="row marginTB10 marginL5">
                                <div class="col-xs-6 col-sm-4">
                                ...
                                <div class="col-xs-12 col-md-7">
                                    <input value="{{dueday | date: 'dd/MM/yyyy'}}" type="date" class="form-control inputForm" #duedate id="duedate" placeholder="Due Date" disabled/>
                                </div>
                            </div>
                            <div class="row marginTB10 marginL5">
                                <div class="col-xs-6 col-sm-4">
