        ...
        <div class="page-content inset" data-spy="scroll" data-target="#spy">
            <div class="row subInfo">
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="row marginTB10 marginL5">
                                ...
                                <div class="col-xs-12 col-md-7">
                                    ...
                                    <input *ngIf="subs.status != 'registrasi'" value="" type="number" class="form-control inputForm" #cablerj45price id="cablerj45price" placeholder="Cable/Rj45 Price" disabled/>
                                </div>
                            </div>
                ...
                <div class="row" style="margin-left: 3px !important;">
                    <div class="col-sm-12">
                        <!-- Small modal -->
                        <button type="submit" (click)="createInvoice(invoicedate.value, duedate.value, namepackage.value, packageprice.value, routerprice.value, stbprice.value, cablerj45price.value, instalationprice.value, subtotal.value, promoname.value, promoprice.value,  totalprice.value)" class="btn btn-default buttonOrange marginT20 marginL20 paddingL10">CONFIRM</button>
                    </div>
                </div>
            </div>
        </div>
...
// Add one person to the API
  createInvoice(invoicedate, duedate, namepackage, packageprice, routerprice, stbprice, cablerj45price, instalationprice, subtotal, promoname, promoprice,  totalprice) {
alert('test');
