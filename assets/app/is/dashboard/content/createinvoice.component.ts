        ...
        <div class="page-content inset" data-spy="scroll" data-target="#spy">
            <div class="row subInfo">
                ...
                <div class="row" style="margin-left: 3px !important;">
                    <div class="col-sm-12">
                        <!-- Small modal -->
                        <button type="submit" (click)="createInvoice(invoicedate.value, duedate.value, namepackage.value, packageprice.value, instalationprice.value, subtotal.value, promoname.value, promoprice.value, taxprice.value, totalprice.value)" class="btn btn-default buttonOrange marginT20 marginL20 paddingL10">CONFIRM</button>
                    </div>
                </div>
            </div>
        </div>
...
// Add one person to the API
  createInvoice(invoicedate, duedate, namepackage, packageprice,  instalationprice, subtotal, promoname, promoprice, taxprice, totalprice) {
alert('test');
