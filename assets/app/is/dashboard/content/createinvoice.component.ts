                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            ...
                            <div class="row marginTB10 marginL5">
                                ...
                                <div class="col-xs-12 col-md-7">
                                    <input [(ngModel)]="subs.packlev" type="text" class="form-control inputForm" ngControl="namepackage" #namepackage id="namepackage" placeholder="Package Level" />
                                </div>
                            </div>
                            <div class="row marginTB10 marginL5">
                                <div class="col-xs-6 col-sm-4">
                                ...
                                <div class="col-xs-12 col-md-7">
                                    <input [(ngModel)]="subs.packprice" type="text" class="form-control inputForm" ngControl="packageprice" #packageprice id="packageprice" placeholder="Package Price" />
                                </div>
                            </div>
                            <div class="row marginTB10 marginL5">
                                <div class="col-xs-6 col-sm-4">
                            ...
                            <div class="row marginTB10 marginL5" >
                                ...
                                <div class="col-xs-12 col-md-7">
                                    <input value="40000" type="text" class="form-control inputForm" #routerprice id="routerprice" placeholder="Router Rent" />
                                </div>
                            </div>
                            <div class="row marginTB10 marginL5" >
                                <div class="col-xs-6 col-sm-4">
                                ...
                                <div class="col-xs-12 col-md-7">
                                    <input *ngIf="subs.packlev == '1' || subs.packlev == '2' || subs.packlev == '3'" value="0" type="text" class="form-control inputForm" #stbprice id="stbprice" placeholder="STB Rent" />
                            ...
                            <div class="row marginTB10 marginL5">
                                ...
                                <div class="col-xs-12 col-md-7">
                                    <input *ngIf="subs.status == 'registrasi' || subs.status == 'Account Active'" value="75000" type="text" class="form-control inputForm" #instalationprice id="instalationprice" placeholder="Instalation Price" />
                                </div>
                            </div>
                            <div class="row marginTB10 marginL5">
                                <div class="col-xs-6 col-sm-4">
                                ...
                                <div class="col-xs-12 col-md-7">
                                    <input value="0" type="text" class="form-control inputForm" #cablerj45price id="cablerj45price" placeholder="Cable/Rj45 Price"/>
                                </div>
                            </div>
                            <div class="row marginTB10 marginL5">
                                <div class="col-xs-6 col-sm-4">
                                ...
                                <div class="col-xs-12 col-md-7">
                                    <input [(ngModel)]="subs.pinaltypay" type="text" class="form-control inputForm" ngControl="pinaltyprice" #pinaltyprice id="pinaltyprice" placeholder="Pinalty Price" />
                                </div>
                            </div>
                            <div class="row marginTB10 marginL5">
                                <div class="col-xs-6 col-sm-4">
                                ...
                                <div class="col-xs-12 col-md-7">
                                    <input [(ngModel)]="totalharga" type="text" class="form-control inputForm" ngControl="subtotal" #subtotal id="subtotal" placeholder="Sub Total" />
                                </div>
                            </div>
                            <div class="row marginTB10 marginL5">
                                <div class="col-xs-6 col-sm-4">
                                ...
                                <div class="col-xs-12 col-md-7">
                                    <input [(ngModel)]="tax"  type="text" class="form-control inputForm" ngControl="taxprice" #taxprice id="taxprice" placeholder="Tax" />
                                </div>
                            </div>
                            <div class="row marginTB10 marginL5">
                                <div class="col-xs-6 col-sm-4">
                                ...
                                <div class="col-xs-12 col-md-7">
                                    <input [(ngModel)]="total"  type="text" class="form-control inputForm" ngControl="totalprice" #totalprice id="totalprice" placeholder="Sub Total" />
                                </div>
                            </div>
                        </div>
                    </div>
