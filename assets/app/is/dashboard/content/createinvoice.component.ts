            ...
            <div class="row subInfo">
                ...
                <div class="row" style="margin-left: 3px !important;">
                    <div class="col-sm-12">
                        ...
                        <!-- Small modal -->
                        <button type="submit" (click)="createInvoice(invoicedate.value, duedate.value, namepackage.value, packageprice.value, promoname.value, routerprice.value, stbprice.value, instalationprice.value, cablerj45price.value, pinaltyprice.value, subtotal.value, taxprice.value, totalprice.value)" class="btn btn-default buttonOrange marginT20 marginL20 paddingL10">CONFIRM</button>
                    </div>
                </div>
            </div>
        </div>
...
// Add one person to the API
  createInvoice(invoicedate, duedate, namepackage, packageprice, promoname,  routerprice, stbprice, instalationprice, cablerj45price, pinaltyprice, subtotal, taxprice, totalprice) {
  var body = `billdate=${invoicedate}&duedate=${duedate}&namepack=${namepackage}&pricepack=${packageprice}&promoname=${promoname}&pricerouter=${routerprice}&
