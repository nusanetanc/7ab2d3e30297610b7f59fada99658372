                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            ...
                            <div class="row marginTB10 marginL5">
                                ...
                                <div class="col-xs-12 col-md-7">
                                    <input [(ngModel)]= "Number(subs.pinaltypay) + Number(packages.price) + Number(routerprice.value)" type="number" class="form-control inputForm" #subtotal id="subtotal" placeholder="Sub Total" />
                                </div>
                            </div>
                            <div class="row marginTB10 marginL5">
                                <div class="col-xs-6 col-sm-4">
