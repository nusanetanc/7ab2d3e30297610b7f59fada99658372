                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="row marginTB10 marginL5">
                                ...
                                <div class="col-xs-12 col-md-7">
                                    ...
                                    <input #cablerj45price id="cablerj45price" (keyup)="0" *ngIf="subs.status != 'registrasi'" value="" type="number" class="form-control inputForm" placeholder="Cable/Rj45 Price"/>
                                </div>
                            </div>
                            {{cablerj45price.value}}
                            <div class="row marginTB10 marginL5">
                                <div class="col-xs-6 col-sm-4">
