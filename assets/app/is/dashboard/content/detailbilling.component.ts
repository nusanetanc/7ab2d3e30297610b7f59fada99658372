                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="row rowButton">
                            <div class="col-sm-12">
                                ...
                                <button (click)="onItemClicked2(Pack)" onclick="printPenagihan()" class="btn btn-default buttonOrange" type="button" style="float:right;" *ngIf="clickedItem.name == 'regArea'">
                                    Print
                                </button>
