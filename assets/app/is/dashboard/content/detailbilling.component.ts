                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="row rowButton">
                            <div class="col-sm-12">
                                ...
                                <button (click)="onItemClicked2(Payment)" class="btn btn-default buttonOrange" type="button" style="float:right; margin-right:20px;" *ngIf="clickedItem.name == 'regInvoice'">
                                    Pembayaran
                                </button>
                            </div>
                        </div>
