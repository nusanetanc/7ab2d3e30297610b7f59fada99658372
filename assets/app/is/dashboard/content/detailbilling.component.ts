                                        ...
                                        <div class="row rowBillInfoP2">
                                            <div class="col-sm-12">
                                                ...
                                                <ul>
                                                    ...
                                                    <li style="margin-bottom: 10px;">2. Pembayaran khusus nasabah BCA atau giro (bank lain dan BCA) ditunjukan ke Rekening Virtual BCA No. Rekening 02750<script>var subs_id={{bills.subid}}; subs_id.substring(2,8);</script> a/n GROOVY {{ bills.name }}.</li>
