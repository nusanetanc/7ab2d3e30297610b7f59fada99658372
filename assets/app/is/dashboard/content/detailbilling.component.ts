                                        ...
                                        <div class="row rowBillInfoP2">
                                            <div class="col-sm-12">
                                                ...
                                                <ul>
                                                    ...
                                                    <li style="margin-bottom: 10px;">2. Payment BCA customers or giro (another bank and BCA) is addressed to BCA Virtual Account No. 02750181597 on behalf of GROOVY {{ bills.name }}</li>
