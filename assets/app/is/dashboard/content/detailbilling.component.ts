                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <div class="row hid">
                                                    <div class="col-sm-12">
                                                        ...
                                                        <div class="col-sm-2">
                                                            <span class="right">Amount (IDR)</span>
                                                        </div>
                                                    </div>
                                                </div>
                                                <!-- /HeaderList -->
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-12 listWhite">
                                                        ...
                                                        <div class="col-sm-2">
                                                            <span class="right">{{ bills.pricepack | currency:'IDR':true:'2.2-4'}}</span>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-sm-12 listWhite">
                                                        ...
                                                        <div class="col-sm-2">
                                                            <span class="right">{{ bills.pricerouter | currency:'IDR':true:'2.2-4' }}</span>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-sm-12 listWhite">
                                                        ...
                                                        <div class="col-sm-2">
                                                            <span class="right">{{ bills.pricestb | currency:'IDR':true:'2.2-4' }}</span>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-sm-12 listWhite">
                                                        ...
                                                        <div class="col-sm-2">
                                                            <span class="right">{{ bills.pricerj45cable | currency:'IDR':true:'2.2-4' }}</span>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-sm-12 listWhite">
                                                        ...
                                                        <div class="col-sm-2">
                                                            <span class="right">{{ bills.priceinstal | currency:'IDR':true:'2.2-4' }}</span>
                                                        </div>
                                                    </div>
                                                </div>
                                                <!-- /List -->
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-12 listGrey">
                                                        ...
                                                        <div class="col-sm-2">
                                                            <span class="right">{{ bills.totalprice | currency:'IDR':true:'2.2-4' }}</span>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-sm-12 listGrey">
                                                        ...
                                                        <div class="col-sm-2">
                                                            <span class="right">{{ bills.changetax | currency:'IDR':true:'2.2-4' }}</span>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
