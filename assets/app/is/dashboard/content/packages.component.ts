                                ...
                                <div class="col-sm-6">
                                    <div class="formNewReport marginLR20">
                                        <form [ngFormModel]="myForm">
                                            ...
                                            <input class="ws-number ws-inputreplace form-control inputForm wsshadow-1500456238232 has-input-buttons user-success" type="text" placeholder="Price" value="" aria-required="false" inputmode="numeric" aria-labelledby="" style="margin-left: 0px; margin-right: 0px; padding-right: 15px; width: 444.2px;">
                                        </form>                                     
