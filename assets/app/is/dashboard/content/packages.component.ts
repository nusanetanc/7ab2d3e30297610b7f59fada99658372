                                ...
                                <div class="col-sm-6">
                                    <div class="formNewReport marginLR20">
                                        <form [ngFormModel]="myForm">
                                            ...
                                            <input id="price" #price min="0" step="0.01" data-number-to-fixed="2" data-number-stepfactor="100" type="number" class="form-control inputForm" placeholder="Price">
                                            </form>                                     
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12" *ngFor="#package of packages">
                                            <div class="row subInfo">
                                                ...
                                                <div class="col-sm-2 invoiceList"><span>{{package.price | number:'2.2-4'}}</span></div>
