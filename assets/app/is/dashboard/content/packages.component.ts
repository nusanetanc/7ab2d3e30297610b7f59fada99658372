                                ...
                                <div class="col-sm-6">
                                    <div class="formNewReport marginLR20">
                                        <form [ngFormModel]="myForm">
                                            ...
                                            <input [ngFormControl]="myForm.find('price')" min="0" step="0.01" data-number-to-fixed="2" data-number-stepfactor="100" #price type="text" class="form-control inputForm" id="price" placeholder="Price">
