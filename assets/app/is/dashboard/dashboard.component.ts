...
import {RouteConfig, ROUTER_DIRECTIVES, FORM_PROVIDERS} from 'angular2/router';
...
@Component({
    ...
    `,
    directives: [ContentAllSubsComponent, ContentDashboardComponent, ROUTER_DIRECTIVES, FORM_PROVIDERS],
})
@RouteConfig([
